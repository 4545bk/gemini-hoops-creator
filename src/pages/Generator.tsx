          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <Card className="bg-[#1a1a1a] border-[#333] shadow-2xl">
              ...
              <CardContent className="space-y-6 pt-6">
                <div>
                  <Label htmlFor="image" className="text-white text-lg mb-2 block font-semibold">Upload File</Label>
                    ...
                    <div className="border-2 border-dashed border-[#444] rounded-xl p-8 bg-[#2a2a2a] hover:border-[#f1e728] transition-colors">
                      <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className="text-gray-400 text-xs">{selectedFile ? selectedFile.name : 'No file chosen'}</span>
                        </div>
                      </div>
